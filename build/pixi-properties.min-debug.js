...
(function(anim){
    ...
    anim.skewTo = function() {
        ...
        return new Skew(['skewX', 'skewY']).to([x, y]);
    };
    anim.skewAdd = function() {
        var x, y;
        if (arguments.length === 1) {
            x = arguments[0].x;
            y = arguments[0].y;
        ...
        return new Skew(['skewX', 'skewY']).to([x, y], true);
    };
    anim.skewFromTo = function() {
        var fromX, fromY, toX, toY;
        if (arguments.length === 2) {
            fromX = arguments[0].x;
            fromY = arguments[0].y;
        ...
        return new Skew(['skewX', 'skewY']).from([fromX, fromY]).to([toX, toY]);
    };
